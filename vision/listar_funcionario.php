...
<html lang="pt-br">
    <head>		
        <meta name="description" content="Listar Funcionários"/>
    ...
    <body > 
		...
		<?php
			...
			$retorno = $funcionarioDAO->listarFuncionario();
			$status1 = "";
			$vzs = 1;
		?>
        <div class="container">
			<div class="row">
				<div class="col-12">
                    <div class="table-responsive conteudo-tabela">
            			<table table class="table table-bordered table-striped table-light table-hover  tablesorter" cellspacing="0" summary="Tabela de Funcionarios" id="tabcat">
            				...
            				<tbody>
            					...
            					?>
            							...
            							echo"<td><a href='cadastrar_funcionario.php?oper=A&id={$dado->id_funcionario}'><img src='../figuras/edit-page-blue.gif' title='Alterar'></a></td>";										
            							?>
            						 	&nbsp; &nbsp;<td><a href='cadastrar_funcionario.php?oper=E&id=<?php echo $dado->id_funcionario?>' onclick="return confirm('Deseja Excluir?')"><img src='../figuras/delete-page-blue.gif' title='Excluir'></a></td></th></tr>
            							<?php
            						    $vzs++;
            						}
            					}
						...
						<p><a href="cadastrar_funcionario.php?oper=I" class="btn btn-dark">Cadastrar Funciánario</a></p>
            		</div>
            	</div>
            </div>
        </div>	
